...
//               </button>
//             </div>
//             {promoMessage && <p className='text-sm mt-1 text-green-600'>{promoMessage}</p>}
//           </div>
...
// const Cart = () => {
//   const { products, currency, cartItems, updateQuantity, navigate, setDiscount } = useContext(ShopContext);
